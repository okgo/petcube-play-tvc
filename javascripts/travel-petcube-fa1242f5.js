...
(function() {
  var $controller, YouTubeVideo, initScrollMagic;
  ...
  initScrollMagic = function() {
    var scene_0, scene_1, scene_1_1, scene_2, scene_3, tween_0, tween_1, tween_1_1, tween_2, tween_3;
    tween_0 = new TimelineMax().fromTo(".travel-petcube-main article", .5, {
      x: '-25px',
      opacity: 0
    }, {
      x: '0',
      opacity: 1
    }).fromTo(".travel-petcube-main .advantages-list", .5, {
      y: '25px',
      opacity: 0
    }, {
      y: '0',
    ...
    scene_0 = new ScrollMagic.Scene({
      triggerElement: '.travel-petcube-main'
    }).setTween(tween_0).addTo($controller);
    tween_1 = new TimelineMax().fromTo(".travel-petcube-about .js-animated-text", .5, {
      y: '25px',
      opacity: 0
    }, {
      y: '0',
    ...
    scene_1 = new ScrollMagic.Scene({
      triggerElement: '.travel-petcube-about',
      reverse: false
    }).setTween(tween_1).addTo($controller);
    tween_1_1 = new TimelineMax().fromTo(".travel-petcube-about .video", 1, {
      maxWidth: '1280px'
    }, {
      maxWidth: '1048px'
    });
    scene_1_1 = new ScrollMagic.Scene({
      triggerElement: '.travel-petcube-about .video',
      duration: $('.travel-petcube-about .video').height() / 2
    }).setTween(tween_1_1).addTo($controller);
    tween_2 = new TimelineMax().fromTo(".specs-slide .h1", .5, {
      y: '25px',
      opacity: 0
    }, {
      y: '0',
    ...
    tween_3 = new TimelineMax().fromTo(".travel-petcube-try .js-animated-text", .5, {
      y: '25px',
      opacity: 0
    }, {
      y: '0',
      opacity: 1
    }).fromTo(".travel-petcube-try .video", .5, {
      right: '100%',
      opacity: 0
    }, {
      right: '0',
      opacity: 1
    }).fromTo(".travel-petcube-try .animated-text-block", .5, {
      right: '100%',
      opacity: 0
    }, {
      right: '0',
    ...
    return scene_3 = new ScrollMagic.Scene({
      triggerElement: '.travel-petcube-try',
      reverse: false
  ...
  $(document).ready(function() {
    ...
    if ($('#travel-petcube-video').length > 0) {
      video = new YouTubeVideo('travel-petcube-video', '5aEYpq7Zu_Y');
      video.init(800, 450);
    }
    if ($('#travel-petcube-video-2').length > 0) {
      video = new YouTubeVideo('travel-petcube-video-2', 'g1AdeQ99Ba0');
