...
(function() {
  $(document).ready(function() {
    ...
    $owl.owlCarousel({
      ...
      animateIn: 'fadeIn',
      autoplaySpeed: 500
    }).find('.item .owl-dot').click(function(e) {
      e.preventDefault();
      return $owl.trigger('to.owl.carousel', [$(this).index(), 500]);
    });
    return $owl.on('click', '.owl-item.active', function(e) {
      return $owl.trigger('next.owl.carousel', [500]);
    });
  });
