...
(function() {
  var $controller, initScrollMagic;

  $controller = new ScrollMagic.Controller();

  initScrollMagic = function() {
    var scene_0, scene_1, scene_2, scene_2_1, scene_3, scene_4, scene_5, scene_6, scene_7, scene_8, tween_0, tween_1, tween_2, tween_2_1, tween_3, tween_4, tween_5, tween_6, tween_7, tween_8;
    tween_0 = new TimelineMax().fromTo(".why-petcube-main article", 1, {
      y: '25px',
      opacity: 0
    }, {
      y: '0',
    ...
    scene_0 = new ScrollMagic.Scene({
      triggerElement: '.why-petcube-main'
    }).setTween(tween_0).addTo($controller);
    tween_1 = new TimelineMax().fromTo(".why-petcube-advantages .js-animated-text", .5, {
      y: '25px',
      opacity: 0
    }, {
      y: '0',
      opacity: 1
    }).fromTo(".why-petcube-advantages .advantages-list", .5, {
      y: '25px',
      opacity: 0
    }, {
      y: '0',
    ...
    scene_1 = new ScrollMagic.Scene({
      triggerElement: '.why-petcube-advantages',
      reverse: false
    }).setTween(tween_1).addTo($controller);
    tween_2 = new TimelineMax().fromTo(".why-petcube-videochat .js-animated-text", .5, {
      y: '25px',
      opacity: 0
    }, {
      y: '0',
      opacity: 1
    }).fromTo(".why-petcube-videochat .video", .5, {
      y: '25px',
      opacity: 0
    }, {
      y: '0',
    ...
    scene_2 = new ScrollMagic.Scene({
      triggerElement: '.why-petcube-videochat',
      reverse: false
    }).setTween(tween_2).addTo($controller);
    tween_2_1 = new TimelineMax().fromTo(".why-petcube-videochat .video", 1, {
      maxWidth: '1280px'
    }, {
      maxWidth: '1048px'
    });
    scene_2_1 = new ScrollMagic.Scene({
      triggerElement: '.why-petcube-videochat .video',
      duration: $('.why-petcube-videochat .video').height() / 2
    }).setTween(tween_2_1).addTo($controller);
    tween_3 = new TimelineMax().fromTo(".why-petcube-peacemind .js-animated-text", .5, {
      y: '25px',
      opacity: 0
    }, {
      y: '0',
      opacity: 1
    }).fromTo(".why-petcube-peacemind .spec-list", .5, {
      y: '25px',
      opacity: 0
    }, {
      y: '0',
    ...
    scene_3 = new ScrollMagic.Scene({
      triggerElement: '.why-petcube-peacemind',
      reverse: false
    }).setTween(tween_3).addTo($controller);
    tween_4 = new TimelineMax().to(".why-petcube-sharing .image-container img", .05, {
      opacity: 1
    }).set(".why-petcube-sharing .image-container img", {
      className: "finish"
    });
    scene_4 = new ScrollMagic.Scene({
      triggerElement: '.why-petcube-sharing',
      reverse: false
    }).setTween(tween_4).addTo($controller);
    tween_5 = new TimelineMax().fromTo(".why-petcube-sharing .js-animated-text", .6, {
      x: '-25px',
      opacity: 0
    }, {
      x: '0',
    ...
    tween_6 = new TimelineMax().to(".why-petcube-monitoring .image-container img", .05, {
      opacity: 1
    }).set(".why-petcube-monitoring .image-container img", {
      className: "finish"
    });
    scene_6 = new ScrollMagic.Scene({
      triggerElement: '.why-petcube-monitoring',
      reverse: false
    }).setTween(tween_6).addTo($controller);
    tween_7 = new TimelineMax().fromTo(".why-petcube-monitoring .js-animated-text", .6, {
      x: '-25px',
      opacity: 0
    }, {
      x: '0',
    ...
    tween_8 = new TimelineMax().fromTo(".why-petcube-design  .js-animated-text", .5, {
      y: '25px',
      opacity: 0
    }, {
      y: '0',
      opacity: 1
    }).fromTo(".why-petcube-design  .spec-list", .5, {
      y: '25px',
      opacity: 0
    }, {
      y: '0',
      opacity: 1
    }).set(".why-petcube-design .image-container img", {
      className: "finish"
    });
    return scene_8 = new ScrollMagic.Scene({
      triggerElement: '.why-petcube-design',
      reverse: false
  ...
  $(function() {
    ...
    $('a.burger-button').on('touchstart click', function(event) {
      event.preventDefault();
      $('.region-selector.active').find('.close').trigger('click');
    ...
    YouTubeVideo = function(id, videoId, size) {
      this.id = id || '';
      ...
      this.init = function(w, h) {
        var self;
        this.videoImageElem.style.backgroundImage = 'url(\'//img.youtube.com/vi/' + videoId + '/maxresdefault.jpg\')';
        this.size.w = w || this.size.w;
        this.size.h = h || this.size.h;
      ...
      this.onYouTubeIframeAPIReady = function() {
        ...
        this.videoImageElem.addEventListener('click', this.onVideoImageClick.bind(self), false);
        this.videoImageElem.addEventListener('click', this.onVideoImageClick.bind(self), false);
      };
    ...
    if ($('#why-petcube-video').length > 0) {
      video = new YouTubeVideo('why-petcube-video', '2MOPnwOKZsY');
      return video.init(800, 450);
    }
  });
