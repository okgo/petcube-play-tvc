...
(function() {
  ...
  initScrollMagic = function() {
    var scene_0, scene_1, scene_2, scene_3, tween_0, tween_1, tween_2, tween_3;
    tween_0 = new TimelineMax().fromTo(".discounts-petcube-main article", .5, {
      y: '25px',
      opacity: 0
    }, {
      y: '0',
      opacity: 1
    }).fromTo(".discounts-petcube-main .advantages-list", .5, {
      y: '25px',
      opacity: 0
    }, {
      y: '0',
    ...
    scene_0 = new ScrollMagic.Scene({
      triggerElement: '.discounts-petcube-main'
    }).setTween(tween_0).addTo($controller);
    tween_1 = new TimelineMax().fromTo(".discounts-petcube-video .video", 1, {
      maxWidth: '1280px'
    }, {
      maxWidth: '1048px'
    });
    scene_1 = new ScrollMagic.Scene({
      triggerElement: '.discounts-petcube-video .video',
      duration: $('.discounts-petcube-video .video').height() / 2
    }).setTween(tween_1).addTo($controller);
    tween_2 = new TimelineMax().fromTo(".why-petcube-design .js-animated-text", 1, {
      y: '25px',
      opacity: 0
    }, {
      y: '0',
    ...
    tween_3 = new TimelineMax().to("#design-animated-image", .05, {
      opacity: 1
    }).set("#design-animated-image", {
      className: "finish"
    });
    return scene_3 = new ScrollMagic.Scene({
      triggerElement: '.why-petcube-design .image-container',
      reverse: false
