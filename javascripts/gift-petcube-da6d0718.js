...
(function() {
  ...
  initScrollMagic = function() {
    var scene_0, scene_1, scene_2, scene_3, scene_4, scene_5, tween_0, tween_1, tween_2, tween_3, tween_4, tween_5;
    tween_0 = new TimelineMax().fromTo(".gift-petcube-main article", .5, {
      y: '25px',
      opacity: 0
    }, {
      y: '0',
      opacity: 1
    }).fromTo(".gift-petcube-main .advantages-list", .5, {
      y: '25px',
      opacity: 0
    }, {
      y: '0',
      opacity: 1
    }).fromTo(".gift-petcube-advantages .advantages-list", .5, {
      y: '25px',
      opacity: 0
    }, {
      y: '0',
    ...
    scene_0 = new ScrollMagic.Scene({
      triggerElement: '.gift-petcube-main'
    }).setTween(tween_0).addTo($controller);
    tween_1 = new TimelineMax().fromTo(".gift-petcube-give .h1", .5, {
      y: '25px',
      opacity: 0
    }, {
      y: '0',
      opacity: 1
    }).fromTo(".gift-petcube-give h3", .5, {
      x: '-25px',
      opacity: 0
    }, {
      x: '0',
      opacity: 1
    }).fromTo(".gift-petcube-give .static-img.first", .25, {
      x: '-50px',
      opacity: 0
    }, {
      x: '0',
      opacity: 1
    }).fromTo(".gift-petcube-give .static-img.second", .25, {
      x: '-50px',
      opacity: 0
    }, {
      x: '0',
      opacity: 1
    }).fromTo(".gift-petcube-give .static-img.third", .25, {
      x: '-50px',
      opacity: 0
    }, {
      x: '0',
    ...
    scene_1 = new ScrollMagic.Scene({
      triggerElement: '.gift-petcube-give',
      reverse: false
    }).setTween(tween_1).addTo($controller);
    tween_2 = new TimelineMax().fromTo(".gift-petcube-text .text", .5, {
      y: '25px',
      opacity: 0
    }, {
      y: '0',
    ...
    scene_2 = new ScrollMagic.Scene({
      triggerElement: '.gift-petcube-text',
      reverse: false
    }).setTween(tween_2).addTo($controller);
    tween_3 = new TimelineMax().fromTo(".gift-petcube-instashop .insta-card-container", .5, {
      x: '-25px',
      opacity: 0
    }, {
      x: '0',
    ...
    scene_3 = new ScrollMagic.Scene({
      triggerElement: '.gift-petcube-instashop',
      reverse: false
    }).setTween(tween_3).addTo($controller);
    tween_4 = new TimelineMax().fromTo(".gift-petcube-perks .bg-image", .5, {
      x: '-50px',
      opacity: 0
    }, {
      x: '0',
      opacity: 1
    }).fromTo(".gift-petcube-perks .text", .5, {
      x: '-25px',
      opacity: 0
    }, {
      x: '0',
    ...
    scene_4 = new ScrollMagic.Scene({
      triggerElement: '.gift-petcube-perks',
      reverse: false
    }).setTween(tween_4).addTo($controller);
    tween_5 = new TimelineMax().fromTo(".specs-slide .h1", .5, {
      y: '25px',
      opacity: 0
    }, {
      y: '0',
      opacity: 1
    }).fromTo(".specs-slide .js-animated-text", .5, {
      y: '25px',
      opacity: 0
    }, {
      y: '0',
  ...
  $(document).ready(function() {
    initScrollMagic();
    return $('.color-choose .switch.colors a').on('click', function(e) {
      var $color, $colorField, $photo, $section;
      e.preventDefault();
      $color = $(this);
      $section = $color.closest('.color-choose');
      $photo = $section.find('.photo .' + $color.data('value'));
